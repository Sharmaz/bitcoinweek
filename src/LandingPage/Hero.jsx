...
function Hero() {
  ...
  return (
    <div className="flex flex-col justify-center items-center my-10">
      <img src={Logo} alt="BitcoinWeek Logo" className="w-[300px] md:w-[500px] lg:w-[600px]" />
      <div className="flex flex-col justify-center items-center text-white w-[300px] md:w-[600px] text-center my-5">
        <h2 className="text-lg md:text-2xl lg:text-3xl">Del 21 de al 25 de Abril</h2>
        {/* <h2 className="text-lg my-2">Durante Talent Land estaremos en @FutureLand, stand No. 11 (frente al podio).</h2> */}
