      ...
      <div className="relative z-10 flex flex-col justify-center items-center text-white w-[300px] md:w-[600px] text-center">
        ...
        <form className="rounded-2xl p-4 text-slate-900 w-[300px] md:w-[400px]" action="https://formspree.io/f/xkgjpyqn" method="POST">
          <div className="flex align-middle my-3 md:my-4 w-full">
            <input className="rounded-lg p-4 w-full m-0.5" type="text" name="fullname" placeholder="Full Name" />
          </div>
          <div className="flex align-middle my-3 md:my-4 w-full">
            <input className="rounded-lg p-4 w-full m-0.5 " type="email" name="email" placeholder="Email Address" />
          </div>
          <div className="flex align-middle my-3 md:my-4">
            <input className="rounded-lg p-4 w-full m-0.5" type="text" name="subject" placeholder="Subject" />
          </div>
          <div className="flex align-middle my-3 md:my-8">
            <textarea className="rounded-lg p-4 w-full m-0.5 h-72 md:h-auto" name="message" cols={30} rows={5} placeholder="How can I help you?" />
          </div>
          <div className="flex align-middle justify-center mt-4 md:mt-8 md:w-1/2">
            <button className="bg-cyan-500 rounded-lg p-4 w-full m-0.5 text-center text-slate-100" type="submit">Send Message</button>
          </div>
        </form>
      </div>
    </div>
